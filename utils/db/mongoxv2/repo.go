...
type Repoer[T IDModeler] interface {
	...
	UpdateAndReturn(ctx context.Context, filter interface{}, update interface{}, opts ...*options.FindOneAndUpdateOptions) (T, error)
	ReplaceOne(ctx context.Context, filter interface{}, data T, opts ...*options.ReplaceOptions) (*mongo.UpdateResult, error)
...
func (repo Repo[T]) CreateMany(ctx context.Context, data []T, opts ...*options.InsertManyOptions) (*mongo.InsertManyResult, error) {
...
func (repo Repo[T]) UpdateOne(ctx context.Context, filter interface{}, update interface{}, opts ...*options.UpdateOptions) (*mongo.UpdateResult, error) {
	return UpdateOneT[T](ctx, filter, update, opts...)
}

func (repo Repo[T]) UpdateMany(ctx context.Context, filter interface{}, update interface{}, opts ...*options.UpdateOptions) (*mongo.UpdateResult, error) {
	return UpdateManyT[T](ctx, filter, update, opts...)
}

func (repo Repo[T]) UpdateAndReturn(ctx context.Context, filter interface{}, update interface{}, opts ...*options.FindOneAndUpdateOptions) (T, error) {
	return UpdateAndReturn[T](ctx, filter, update, opts...)
}

func (repo Repo[T]) ReplaceOne(ctx context.Context, filter interface{}, data T, opts ...*options.ReplaceOptions) (*mongo.UpdateResult, error) {
...
func (repo Repo[T]) Aggregate(ctx context.Context, results interface{}, pipeline []interface{}, opts ...*options.AggregateOptions) error {
	return AggregateT[T](ctx, results, pipeline, opts...)
}

func (repo Repo[T]) BulkWrite(ctx context.Context, models []mongo.WriteModel, opts ...*options.BulkWriteOptions) (*mongo.BulkWriteResult, error) {
